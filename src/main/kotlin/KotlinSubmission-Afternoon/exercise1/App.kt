 ...
 */
fun myProfile() {
    val Namadepan: String = "Husna"
    val Namabelakang: String = "Sabila"
    val age: Int = 21
 ...
 */
fun myTeam(): List<Any> {
    val groupMembers = listOf("Arid Alimudin", "Abdurahman Aziz", "Muhammad Nashir", "Octavian Dava", "Husna Sabila")
...
fun totalMember(): Int {
    ...
    val countOfGroup = arrayOf("Arid Alimudin", "Abdurahman Aziz", "Muhammad Nashir", "Octavian Dava", "Husna Sabila")
...
fun main() {
     ...
     *
     */
    groupDetail("EnviGrowth", listOf("Arid Alimudin","Abdurahman Aziz","Muhammad Nashir","Octavian Dava", "Husna Sabila"), "B Siang")
